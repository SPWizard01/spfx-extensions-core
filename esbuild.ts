...
const result = buildSync({
    entryPoints: ["./src/index.ts", "./src/__spfx.ts", "./src/core/__spfxCore.ts", "./src/services/spContextService.ts", "./src/services/appLauncher.ts", "./src/core/coreClassicWrapper.ts", "./src/core/coreClassicCustomAction.ts", "./src/utilities/common.ts", "./src/utilities/display.ts"],
    sourcemap: "linked",
    outdir: "./dist",
    platform: "browser",
    format: "esm",
